...
namespace SpookyCore.Utilities.Editor
{
	...
	public static class SceneAutoLoader
	{
		...
		[MenuItem("SpookyTools/Scene Auto Loader/Select Bootstrap Scene")]
		...
		[MenuItem("SpookyTools/Scene Auto Loader/Enable Load Bootstrap On Play")]
		...
		[MenuItem("SpookyTools/Scene Auto Loader/Disable Load Bootstrap On Play")]
		...
		[MenuItem("SpookyTools/Scene Auto Loader/Enable Load Bootstrap On Play", true)]
		private static bool ShouldHighlightEnableLoadBootstrapOnPlay()
		{
			return !LoadBootstrapOnPlay;
		}
		
		[MenuItem("SpookyTools/Scene Auto Loader/Disable Load Bootstrap On Play", true)]
